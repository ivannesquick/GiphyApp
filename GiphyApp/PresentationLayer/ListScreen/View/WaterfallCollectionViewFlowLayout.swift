...
protocol WaterfallCollectionViewFlowLayoutDelegate: AnyObject {
    func collectionView(
...
final class WaterfallCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    weak var delegate: WaterfallCollectionViewFlowLayoutDelegate?
